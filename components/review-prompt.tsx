...
export function ReviewPrompt({ milestone, message, orgId }: ReviewPromptProps) {
  ...
  return (
    <div className="flex items-center gap-3 bg-gold-50 border border-gold-300 rounded-xl px-4 py-3 mb-6 animate-fade-in">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <button
          ...
          className="text-accent-400 hover:text-accent-600 p-1 transition-colors"
          title="Maybe later"
        >
          <X className="w-4 h-4" />
        </button>
