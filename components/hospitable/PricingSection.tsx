...
//
// Mirrors components/ownerrez/PricingSection.tsx by design — same plan data,
// same layout — with ctaHref pointed at the hospitable provider instead of
// ownerrez. Kept as a separate per-integration component (not a shared
// generic one) to match the existing components/ownerrez/ convention and
// avoid touching the live OwnerRez page while this ships.
