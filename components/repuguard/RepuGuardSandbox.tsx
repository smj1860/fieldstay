    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ color: "#2a4a6e", fontSize: 13 }}>
            Interactive Demo
          </span>
        </div>
        <span
          style={{ fontSize: 12, color: "#1e3a5e", fontStyle: "italic" }}
        >
      ...
      >
        {SCENARIOS.map((s) => (
          <button
            ...
            style={{
              background:
                selected?.id === s.id ? s.dimColor : "#0a1628",
              border: `1px solid ${
                selected?.id === s.id ? s.borderColor : "#0e2040"
              }`,
              borderRadius: 10,
              padding: "10px 8px",
              cursor: "pointer",
          ...
          >
            <div
              style={{
                ...
                fontWeight: 700,
                color:
                  selected?.id === s.id ? s.color : "#3a5a7e",
                lineHeight: 1.3,
              }}
            >
              {s.label}
              ...
              >
                ...
                >
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: "#2a4a6e" }}>
              ...
              >
                ...
                {phase === "thinking" && (
                  <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                    ...
                    />
                    <span style={{ fontSize: 11, color: "#FCD116" }}>
                      Analyzing review…
                    </span>
                  </div>
                )}
