...
CREATE TABLE IF NOT EXISTS public.work_order_invoices (
  ...
  invoice_number            text        NOT NULL,  -- e.g. INV-2026-00001
...
-- RLS: mirrors property_owners pattern — admins/managers manage, org members read
...
-- Indexes for PM invoice dashboard queries
