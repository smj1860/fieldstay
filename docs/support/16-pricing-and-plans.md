...
FieldStay is priced by the number of properties you manage. Every plan includes the full platform — there are no plan-tier feature gates or add-ons required to access core functionality. (The one exception is the Guest Guidebook, which has its own separate unlock condition — see below.)
...
Contact hello@fieldstay.app for Enterprise pricing.

---

## What Every Plan Includes

All plans include the complete FieldStay platform:
...
Annual billing is available at a discount equivalent to 2 months free — roughly 17% off the monthly rate. Annual plans are billed once per year upfront.
...
limit. To add more properties, go to **Settings → Billing** and click the
**Upgrade** button next to the tier you want — your new limit applies
immediately.
