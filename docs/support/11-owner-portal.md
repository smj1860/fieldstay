...
**The Owner Portal gives property owners a read-only view of their property's financial performance — revenue, expenses, and net income — without giving them access to your full FieldStay account.**
...
The portal shows:
- **Revenue** — booking income posted automatically from your connected PMS (OwnerRez, Hospitable, Hostex, or Hostaway)
...
## Controlling What Owners See

Not every expense needs to be visible to owners. Each transaction has a **Visible to Owner** toggle. By default:

- Booking revenue → visible to owner
- Cleaning fees → visible to owner
...
## How Expenses Post Automatically
...
If an owner has multiple properties, all their properties can be accessed from a single portal link. When sharing the portal, FieldStay automatically includes all properties associated with that owner.
