...
1. Go to Inventory → Templates and select or create a template
2. Click Apply to Property for each applicable property
3. Go to Inventory → [Property Name] and adjust par levels per property as needed
