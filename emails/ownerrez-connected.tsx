...
export function OwnerRezConnectedEmail({ firstName, orgName, dashboardUrl }: Props) {
  return (
    <EmailLayout
      preview="OwnerRez connected — your properties are syncing now."
      ctaLabel="View your properties →"
      ctaUrl={dashboardUrl}
      footerNote={`You're receiving this because you connected OwnerRez to your FieldStay account for ${orgName}.`}
    >
      <Text style={heading}>OwnerRez connected.</Text>
      <Text style={body}>
        Hi {firstName} — your OwnerRez account is connected and your properties
      ...
      <Section style={infoRow}>
        <Text style={infoItem}>✦ Booking changes sync in real time via webhooks</Text>
      </Section>
...
export async function renderOwnerRezConnectedEmail(props: Props): Promise<string> {
  return render(<OwnerRezConnectedEmail {...props} />)
}
