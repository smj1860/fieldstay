...
import { applyMasterChecklistToProperties } from '@/app/(dashboard)/templates/checklist/actions'
...
describe('templates/checklist/actions — applyMasterChecklistToProperties', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
