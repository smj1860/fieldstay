...
const RECONCILERS: Record<string, Reconciler> = {
  ...
  'lib/inngest/functions/hostex/staff-sync.ts:193': {
    protection: 'empty-set-guard',
  ...
  'lib/inngest/functions/hospitable/calendar-sync-handler.ts:184': {
  ...
  'lib/dexie/dashboard/warm-maintenance-board.ts:216': {
    protection: 'fetch-fails-loud',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:438': {
    protection: 'fetch-fails-loud',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:346': {
    protection: 'fetch-fails-loud',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:539': {
    protection: 'fetch-fails-loud',
...
const CLEAR_AND_REPLACE: Record<string, Reconciler> = {
  'lib/dexie/dashboard/warm-maintenance-board.ts:256': {
    protection: 'fetch-fails-loud',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:263': {
    protection: 'fetch-fails-loud',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:334': {
    protection: 'empty-set-guard',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:335': {
    protection: 'empty-set-guard',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:336': {
    protection: 'empty-set-guard',
...
describe('guardrail: reconciling by absence must survive an empty fetch', () => {
  ...
  it('the scan itself fires — a broken checker looks exactly like a clean tree', () => {
    ...
    expect(cleared).toContain('lib/dexie/dashboard/warm-inspections.ts:263')
