...
const RECONCILERS: Record<string, Reconciler> = {
  ...
  'lib/dexie/dashboard/warm-inspections.ts:394': {
    protection: 'fetch-fails-loud',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:495': {
    protection: 'fetch-fails-loud',
...
const CLEAR_AND_REPLACE: Record<string, Reconciler> = {
  ...
  'lib/dexie/dashboard/warm-inspections.ts:219': {
    protection: 'fetch-fails-loud',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:290': {
    protection: 'empty-set-guard',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:291': {
    protection: 'empty-set-guard',
  ...
  'lib/dexie/dashboard/warm-inspections.ts:292': {
    protection: 'empty-set-guard',
...
describe('guardrail: reconciling by absence must survive an empty fetch', () => {
  ...
  it('the scan itself fires — a broken checker looks exactly like a clean tree', () => {
    ...
    expect(cleared).toContain('lib/dexie/dashboard/warm-inspections.ts:219')
