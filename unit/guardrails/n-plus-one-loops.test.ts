...
const EXCEPTIONS: Record<string, string> = {
  ...
  'app/(dashboard)/properties/clone-actions.ts:121':
  ...
  'lib/inngest/functions/checklist-broadcast.ts:124':
    'Per-section insert (parent-before-child, same reasoning as clone-actions.ts:121) — additionally guarded by a template-signature equality check just above that skips the whole delete-then-recreate rebuild when nothing changed.',
  ...
  'lib/inngest/functions/ownerrez/initial-sync.ts:179':
