...
const BASELINE: Record<string, number> = {
  ...
  'app/(dashboard)/messages/actions.ts': 5,
  ...
  'app/api/webhooks/stripe/handlers/core-billing.ts': 3,
  ...
  'lib/inngest/functions/capex-projection-trigger.ts': 3,
  'lib/inngest/functions/capex-projections.ts': 4,
  ...
  'lib/inngest/functions/depreciation-ledger.ts': 1,
