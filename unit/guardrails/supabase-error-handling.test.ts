...
const BASELINE: Record<string, number> = {
  ...
  'app/(dashboard)/properties/actions.ts': 7,
  ...
  'app/(dashboard)/turnovers/actions.ts': 20,
  ...
  'app/api/crew/inventory-count/route.ts': 5,
  ...
  'lib/inngest/functions/auto-assign-turnover.ts': 7,
  ...
  'lib/inngest/functions/ownerrez/incremental-sync.ts': 5,
