...
export const DEMO_PROPERTIES: DemoPropertySeed[] = [
  {
    ...
    lat: 30.245_8, lng: -87.708_3, flagship: true,
  },
  {
    ...
    lat: 30.271_4, lng: -87.563_9, flagship: true,
  },
  {
    ...
    lat: 30.249_1, lng: -87.688_2, flagship: false,
  },
  {
    ...
    lat: 30.256_7, lng: -87.712_5, flagship: false,
  },
  {
    ...
    lat: 30.284_2, lng: -87.591_1, flagship: false,
  },
  {
    ...
    lat: 30.279_8, lng: -87.574_6, flagship: false,
  },
  {
    ...
    lat: 30.276_3, lng: -87.556_8, flagship: false,
  },
  {
    ...
    lat: 30.241_2, lng: -87.723_9, flagship: false,
  },
  {
    ...
    lat: 30.245_1, lng: -87.703_4, flagship: false,
  },
]
...
export const DEMO_CREW: DemoCrewSeed[] = [
  {
    ...
    role: 'cleaning', home_zip: '36542', home_lat: 30.247_9, home_lng: -87.701_2,
  ...
  },
  {
    ...
    role: 'maintenance', home_zip: '36561', home_lat: 30.281_5, home_lng: -87.570_3,
  ...
  },
  {
    ...
    role: 'cleaning', home_zip: '36561', home_lat: 30.274_2, home_lng: -87.561_7,
    reliability_score: 0.88, capacity_score: 0.60,
  },
  {
    key: 'ronnie', name: 'Ronnie Pyle', email: 'ronnie.pyle@example.com', phone: '+12515550167',
    role: 'general', home_zip: '36542', home_lat: 30.252_4, home_lng: -87.716_8,
  ...
  },
  {
    ...
    role: 'landscaping', home_zip: '36542', home_lat: 30.239_6, home_lng: -87.694_5,
...
export const DEMO_VENDORS: DemoVendorSeed[] = [
  {
    ...
    lat: 30.250_3, lng: -87.699_1, avg_rating: 4.7, rating_count: 34,
  },
  {
    ...
    lat: 30.278_1, lng: -87.568_2, avg_rating: 4.5, rating_count: 21,
  },
  {
    ...
    lat: 30.406_5, lng: -87.683_4, avg_rating: 4.8, rating_count: 47,
  },
  {
    ...
    city: 'Gulf Shores', state: 'AL', service_zip: '36542',
    lat: 30.243_7, lng: -87.710_6, avg_rating: 4.3, rating_count: 18,
  },
  {
    ...
    city: 'Orange Beach', state: 'AL', service_zip: '36561',
    lat: 30.272_9, lng: -87.579_5, avg_rating: 4.6, rating_count: 29,
  },
  {
    ...
    city: 'Gulf Shores', state: 'AL', service_zip: '36542',
    lat: 30.254_8, lng: -87.692_3, avg_rating: 4.4, rating_count: 25,
  },
  {
    ...
    city: 'Orange Beach', state: 'AL', service_zip: '36561',
    lat: 30.283_6, lng: -87.585_7, avg_rating: 4.9, rating_count: 52,
  },
]
...
export const DEMO_SPONSORS: DemoSponsorSeed[] = [
  {
    ...
    address: '1520 W Beach Blvd, Gulf Shores, AL 36542', lat: 30.244_9, lng: -87.714_2,
  ...
  },
  {
    ...
    address: '27 Marina Way, Orange Beach, AL 36561', lat: 30.286_4, lng: -87.582_1,
  ...
  },
  {
    ...
    address: '308 E 2nd Ave, Gulf Shores, AL 36542', lat: 30.248_3, lng: -87.696_7,
  ...
  },
  {
    ...
    address: '905 Gulf Shores Pkwy, Gulf Shores, AL 36542', lat: 30.256_1, lng: -87.700_8,
  ...
  },
  {
    ...
    address: '450 Perdido Beach Blvd, Orange Beach, AL 36561', lat: 30.273_6, lng: -87.560_2,
