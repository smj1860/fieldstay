      ...
      items: [
        {
          ...
          asset_type: 'smart_lock', concern_key: 'entry_lock_operational',
        },
        {
        ...
        },
        {
          ...
          remediation: 'work_order', default_actions: ['service'],
          wo_category: 'hvac',
          asset_type: 'hvac', concern_key: 'hvac_filter',
        },
      ],
    },
    ...
    // ── 6 ────────────────────────────────────────────────────────────────────
    {
      ...
      items: [
        ...
        },
        {
          ...
          remediation: 'purchase_order', default_actions: ['replace'],
          asset_type: 'washer', concern_key: 'washer_supply_lines',
        },
        {
        ...
        },
        {
          ...
          remediation: 'work_order', default_actions: ['repair'],
          wo_category: 'electrical', wo_priority: 'high',
          asset_type: 'electrical_panel', concern_key: 'electrical_panel_clear',
        },
        {
