...
export type AuditAction =
  ...
  | 'billing.subscription.quantity_prorated'
  ...
  | 'platform_admin.inventory_catalog_item.bulk_imported'
  ...
  | 'platform_admin.prospect_import.started'
  | 'platform_admin.prospect_import.finished'
  | 'platform_admin.prospect_import.undone'
  ...
  | 'platform_admin.prospect_pms.normalized'
