...
> **Status: IN PROGRESS.** Two of three wave-1 dimensions reported. The
> `lib/**` dimension and all of wave 2 (migration history, components/pages,
> integrations/emails, e2e suite quality, adversarial verification) are
> outstanding. Counts below will change.
...
| `lib/**` outside inngest/dexie | *pending* | — | — | — |
